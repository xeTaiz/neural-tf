...
from pl_module_novol import NeuralTransferFunction
...
if __name__=='__main__':
    ...
    logger = loggers.WandbLogger(
            ...
            name=f'NEURALTF_NV_{run_id}_{args.n}',
            id=run_id,
    ...
    # Save source code !
    trainer.logger.experiment.save('pl_train_novol.py')
    trainer.logger.experiment.save('pl_module_novol.py')
